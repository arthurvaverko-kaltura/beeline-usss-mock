...
exports.getInacServiceInfoAvailableservices = function(req, res){
    ...
    var data ={
        ...
        "containers": [
            {
                "serviceType": "TVE_TARIFF_ENTITY",
                "services": [
                    {
                        "price": 249.0,
                        "technicalName": "������� ���� ���� 2018 TVE",
                        "ussName": "������� ���� ���� 2018 TVE USSS",
                        "shortDescription": "������� ��������",
                        "fullDescription": "��������� ��������",
                        "serviceId": "519538",
                        "additionalParams": {
                            "effectivePrice": 249.0,
                                ...
                                "childPackets": [
                                    {
                                        ...
                                        "childPackets": [
                                            {
                                                "price": 150.0,
                                                "technicalName": "VIP Viasat Premium",
                                                "ussName": "VIP Viasat Premium",
                                                "shortDescription": "������� ��������",
                                                "fullDescription": "��������� ��������",
                                                "packetId": "543769",
                                                "parentPacketId": "519543",
                                            ...
                                            {
                                                "price": 199.0,
                                                "technicalName": "Amedia Premium HD - Home of HBO",
                    ...
                    {
                        "price": 300.0,
                        "technicalName": "������� TVE ����� 300",
                        "ussName": "������� TVE ����� 300 USSS",
                        "shortDescription": "������� ��������",
                        "fullDescription": "��������� ��������",
                        "serviceId": "482998",
                        "additionalParams": {
                            "effectivePrice": 300.0,
                            "mobileSubscriber": false,
                            "allowRelatedOfferByFttb": true,
                            "channelCount": 30,
                            "basePktPrice": 300.0,
                    ...
                    {
                        "price": 345.0,
                        "technicalName": "������� 2.0� 2018 TVE",
                        "ussName": "������� 2.0 USSS",
                        "shortDescription": "������� ��������",
                        "fullDescription": "��������� ��������",
                        "serviceId": "519562",
                        "additionalParams": {
                            "effectivePrice": 345.0,
                            "mobileSubscriber": false,
                            "allowRelatedOfferByFttb": true,
                            "channelCount": 30,
                            "basePktPrice": 345.0,
...
exports.getInacServiceInfoConnectedservices = function(req, res){
    ...
    // set response body and send
    var jsonData = {"meta":{"status":"OK","code":20000,"message":null},"containers":[]}
    res.json(jsonData);
};
